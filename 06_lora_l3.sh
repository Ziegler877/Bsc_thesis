...
echo "=== STARTING MARATHON: LLAMA 3 ==="
...
python -u src/train_lora.py --model $MODEL --dataset reuters --epochs 2 --batch_size 2 --use_dora --lr_scheduler cosine
...
python -u src/train_lora.py --model $MODEL --dataset reuters --epochs 2 --batch_size 4 --lora_dropout 0.3 --r 16 --lora_alpha 32
...
python -u src/train_lora.py --model $MODEL --dataset reuters --epochs 3 --batch_size 2 --use_dora --lr_scheduler cosine
...
python -u src/train_lora.py --model $MODEL --dataset reuters --epochs 3 --batch_size 4 --lora_dropout 0.3 --r 16 --lora_alpha 32
...
python -u src/train_lora.py --model $MODEL --dataset reuters --epochs 4 --batch_size 2 --use_dora --lr_scheduler cosine
...
python -u src/train_lora.py --model $MODEL --dataset reuters --epochs 4 --batch_size 4 --lora_dropout 0.3 --r 16 --lora_alpha 32
...
python -u src/train_lora.py --model $MODEL --dataset reuters --epochs 5 --batch_size 2 --use_dora --lr_scheduler cosine
...
python -u src/train_lora.py --model $MODEL --dataset reuters --epochs 5 --batch_size 4 --lora_dropout 0.3 --r 16 --lora_alpha 32
...
python -u src/train_lora.py --model $MODEL --dataset darkreddit --epochs 2 --batch_size 2 --use_dora --lr_scheduler cosine
...
python -u src/train_lora.py --model $MODEL --dataset darkreddit --epochs 2 --batch_size 4 --lora_dropout 0.3 --r 16 --lora_alpha 32
...
python -u src/train_lora.py --model $MODEL --dataset darkreddit --epochs 3 --batch_size 2 --use_dora --lr_scheduler cosine
...
python -u src/train_lora.py --model $MODEL --dataset darkreddit --epochs 3 --batch_size 4 --lora_dropout 0.3 --r 16 --lora_alpha 32
...
python -u src/train_lora.py --model $MODEL --dataset darkreddit --epochs 4 --batch_size 2 --use_dora --lr_scheduler cosine
...
python -u src/train_lora.py --model $MODEL --dataset darkreddit --epochs 4 --batch_size 4 --lora_dropout 0.3 --r 16 --lora_alpha 32
...
python -u src/train_lora.py --model $MODEL --dataset darkreddit --epochs 5 --batch_size 2 --use_dora --lr_scheduler cosine
...
python -u src/train_lora.py --model $MODEL --dataset darkreddit --epochs 5 --batch_size 4 --lora_dropout 0.3 --r 16 --lora_alpha 32
...
echo "=== MARATHON COMPLETE: LLAMA 3 ==="