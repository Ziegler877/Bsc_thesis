...
#SBATCH --gres=gpu:2
#SBATCH --output=results/logs/928_ld_%j.out
#SBATCH --error=results/logs/928_ld_%j.err
...
echo "=========================================="
echo "          STARTING E5 RUN 5               "
echo "=========================================="

python -u src/training/train.py --model e5_large --dataset darkreddit --epochs 100 --patience 10 --batch_size 8 --pooling mean
mv "results/adapters/e5_large_darkreddit" "results/adapters/e5_large_darkreddit_run5"
python -u main.py --model e5_large --dataset darkreddit --lora --pooling mean --suffix "_run5"

echo "=== E5 RUN 5 COMPLETE ==="