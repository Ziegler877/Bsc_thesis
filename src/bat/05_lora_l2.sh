...
#SBATCH --gres=gpu:1
#SBATCH --output=results/logs/05_LoRA_L2_%j.out
#SBATCH --error=results/logs/05_LoRA_L2_%j.err
...
echo "=== STARTING MARATHON: LLAMA 2 ==="
...
# Exp A: DoRA (Low batch + Accumulation for Llama memory safety)
...
# --- Epochs 3, 4, and 5 for DarkReddit follow the same pattern ---

echo "=== MARATHON COMPLETE: LLAMA 2 ==="