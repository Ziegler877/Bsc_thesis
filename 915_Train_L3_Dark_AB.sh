#!/bin/bash
#SBATCH -J 915_L3_Dark_AB
#SBATCH -A p71186
#SBATCH -t 44:00:00
#SBATCH --partition=zen3_0512_a100x2
#SBATCH --qos=zen3_0512_a100x2
#SBATCH --gres=gpu:2
#SBATCH --output=results/logs/915_L3_Dark_AB_%j.out
#SBATCH --error=results/logs/915_L3_Dark_AB_%j.err
...
echo "=== LLAMA 3 DARKREDDIT A/B TESTING ==="
